...
#define ON_BLOCK_EXIT      __attribute__((unused)) ::Loki::ScopeGuard LOKI_ANONYMOUS_VARIABLE(scopeGuard) = ::Loki::MakeGuard
#define ON_BLOCK_EXIT_OBJ  __attribute__((unused)) ::Loki::ScopeGuard LOKI_ANONYMOUS_VARIABLE(scopeGuard) = ::Loki::MakeObjGuard
